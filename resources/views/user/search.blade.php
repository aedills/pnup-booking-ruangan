                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input disabled value="{{ $dataBooking->ruang->lokasi }}" type="text" class="form-control" id="lokasi" name="lokasi"
                                        maxlength="100">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input disabled value="{{ $dataBooking->tanggal }}" type="text" class="form-control" id="tanggal" name="tanggal"
                                        maxlength="100">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    @switch($dataBooking->kode_waktu)
                                        @case(1)
                                            <input disabled value="Pagi - Siang" type="text" class="form-control" id="waktu" name="waktu"
                                            maxlength="100">
                                            @break
                                        @case(2)
                                            <input disabled value="Siang - Sore" type="text" class="form-control" id="waktu" name="waktu"
                                            maxlength="100">
                                            @break
                                        @case(3)
                                            <input disabled value="Pagi - Siang" type="text" class="form-control" id="waktu" name="waktu"
    ...
    @if (isset($success))
        <script>
            Swal.fire({
                toast: true,
                icon: "success",
                title: "Data booking berhasil ditemukan",
